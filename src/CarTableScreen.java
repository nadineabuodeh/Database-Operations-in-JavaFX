...
public class CarTableScreen extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Search.setOnAction(e -> {
			SelectDataInCarTable insertAddress = new SelectDataInCarTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
		...
		Delete.setOnAction(e -> {
			DeleteDataInCarTable insertAddress = new DeleteDataInCarTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
		...
		Insert.setOnAction(e -> {
			InsertDataInCarTable insertAddress = new InsertDataInCarTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
