...
public class ManufactureTableScreen extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Search.setOnAction(e -> {
			SelectDataInManufactureTable insertAddress = new SelectDataInManufactureTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
		...
		Delete.setOnAction(e -> {
			DeleteDataInManufactureTable insertAddress = new DeleteDataInManufactureTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
