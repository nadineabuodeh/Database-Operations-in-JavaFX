...
public class DeviceTableScreen extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Search.setOnAction(e -> {
			SelectDataInDeviceTable insertAddress = new SelectDataInDeviceTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
		...
		Delete.setOnAction(e -> {
			DeleteDataInDeviceTable insertAddress = new DeleteDataInDeviceTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
