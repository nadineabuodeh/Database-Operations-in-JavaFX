...
public class Car_PartTableScreen extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Search.setOnAction(e -> {
			SelectDataInCar_PartTable insertAddress = new SelectDataInCar_PartTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
		...
		Delete.setOnAction(e -> {
			DeleteDataInCarPartTable insertAddress = new DeleteDataInCarPartTable();
			Stage adressStage = new Stage();
			try {
				insertAddress.start(adressStage);
			} catch (Exception e1) {
