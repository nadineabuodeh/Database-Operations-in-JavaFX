...
public class CustomerTableScreen extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Search.setOnAction(e -> {
			SelectDataInCustomerTable search = new SelectDataInCustomerTable();
		...
		Insert.setOnAction(e -> {
			InsertDataInCustomerTable insert = new InsertDataInCustomerTable();
			Stage Stage = new Stage();
			try {
				insert.start(Stage);
			} catch (Exception e1) {
		...
		Delete.setOnAction(e -> {
			DeleteDataInCustomerTable insert = new DeleteDataInCustomerTable();
			Stage Stage = new Stage();
			try {
				insert.start(Stage);
			} catch (Exception e1) {
